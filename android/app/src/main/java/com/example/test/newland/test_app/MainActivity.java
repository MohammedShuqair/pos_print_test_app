                ...
                .setMethodCallHandler(
                        (call, result) -> {
                            ...
                            if (call.method.equals(AppStrings.printMethod)) {
                                int methodResult = printTest();

                                if (methodResult != -1) {
                                    result.success(methodResult);
                                } else {
                                    result.error("UNAVAILABLE", "cant print", null);
                                }
                            } else {
...
//    private int print() {
//        try {
//            // Get an instance of the printer module
//            PrinterModule mPrinterModule = ModuleManage.getInstance().getPrinterModule();
//
//            // Check if the printer module is initialized
//            if (mPrinterModule != null) {
//                // Example print data
//                String printData = "Your print data";
//
//                // Print the data
//                mPrinterModule.print(printData, null, null);
//
//                // Return success code
//                return 1;
//            } else {
//                // Return error code if printer module is not initialized
//                return -1;
//            }
//        } catch (Exception e) {
